...
from app.agent.ports.conversation_store import ConversationStore, StartedTurn
from app.agent.runtime.agent_runtime import AgentRuntime
from app.agent.runtime.run_context import AgentTurnCommand
from app.common.errors import RunCoachError, TurnCancelled as TurnCancelledError
...
class ChatService:
    ...
    async def send_message(
        ...
        *,
        ...
        thread = await self._store.get_or_create_thread(
        ...
        except (asyncio.CancelledError, TurnCancelledError) as exc:
        ...
        return await self._commit(request_context=request_context, started=started, final=final)
